...
import { EditorContent, useEditor, useEditorState ,type Editor,type EditorStateSnapshot} from '@tiptap/react'
...
export function MenuBar({ editor }: { editor: Editor | null }) {
  ...
  const editorState = useEditorState({
    editor,
    selector: (ctx: EditorStateSnapshot | null) => {
      return {
...
function MarkdownEditor({html,setHtml}:{html:string,setHtml:(html:string)=>void}) {
